...
First and foremost, each Sass Fairy v2 package now exports a JavaScript API. These are functions that Sass needs to know about in order to compile stylesheets using the Sass Fairy.
