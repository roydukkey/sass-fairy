...
import packageJson from '@sass-fairy/v1/map/package.json';
import type { ModuleSpec, SpecSignature } from '@site/src/spec/ModuleSpec';
import { centerCompareParameter, compareReferenceCommon } from '@site/versioned_docs/version-1/api/list/spec';
